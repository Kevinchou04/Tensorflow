...
with tf.name_scope('Inference'):
    w1=tf.Variable(tf.random_normal([784,hidden1_notes],stddev=0.1))
    w2=tf.Variable(tf.random_normal([hidden1_notes,10],stddev=0.1))
    b1=tf.Variable(tf.random_normal([hidden1_notes],stddev=0.1))
